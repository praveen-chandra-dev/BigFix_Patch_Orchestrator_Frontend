...
export function Sidebar({ activeMenu, onNavigate, flowState, role }) {
  ...
  return (
    <nav className="sidebar">
      ...
      <div className="sidebar-menu">
        ...
        {/* Added KPI Details shortcut link to Sidebar */}
  ...
  return (
    <div className="topbar-main">
       ...
       <div className="flex-row items-center gap-16">
          ...
          <button className="btn outline danger small" onClick={onLogout} style={{height: 32, padding: "0 12px"}}>
             <IconLogout /> Logout
          </button>
       </div>
    </div>
