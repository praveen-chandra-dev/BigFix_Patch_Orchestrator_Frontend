...
//           <div className="stage-cards-row">
//             <PilotEnvironment mode="pilot" lastActions={lastActions} />            {/* {env.enableSandbox && (
//               <PilotSandboxResult 
...
//                 onViewDetails={(actId) => onNavigate('kpi-details', { type: 'success', id: actId })} 
//               />
//             )}
